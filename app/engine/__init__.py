...
class Engine:
    ...
    def analyze(self, prompt: str, *, improve: bool = False) -> AnalysisResult:
        with ThreadPoolExecutor(max_workers=3) as pool:
            ...
            similar_fut = pool.submit(self._retriever.find_similar_prompts, prompt)
            antipattern_fut = pool.submit(self._retriever.detect_antipatterns, prompt)
        ...
        techniques = self._retriever.find_techniques(prompt, weak_dims)
